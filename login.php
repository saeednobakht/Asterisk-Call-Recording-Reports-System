...
class clogin {
	...
	function ValidateCaptcha() {
		return (strtolower($this->captcha) == strtolower(@$_SESSION["EW_CAPTCHA_CODE"]));
	}
...
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
	<img src="ewcaptcha.php?<?= time() ?>" alt="Security Image" style="width: 220px; height: 50px;"><br><br>
	<input type="text" name="captcha" id="captcha" class="form-control" size="30" style="text-align: center; direction: ltr;" placeholder="<?php echo $Language->Phrase("EnterValidateCode") ?>">
	</div>
</div>
<!-- captcha html (end) -->
	<div class="form-group">
