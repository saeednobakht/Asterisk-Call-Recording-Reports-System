...
if (EW_DEBUG_ENABLED) {
	...
	error_reporting(E_ALL ^ E_DEPRECATED ^ E_STRICT ^ E_NOTICE ^ E_WARNING); // Report all errors except E_NOTICE
}
...
define("EW_PROJECT_NAME", "freepbx", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{274CC91E-1C95-40BB-9BB8-39D2A070EA8E}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'WeUoSIS40HlkcTL6', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/freepbx.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => $XP_DB_HOST, "port" => 3306, "user" => $XP_DB_USER, "pass" => $XP_DB_PASS, "db" => $XP_DB_NAME, "qs" => "`", "qe" => "`");
 ...
 */
define("EW_MYSQL_CHARSET", "utf8mb4", TRUE);
...
$EW_XSS_ARRAY = array(
				#	 'javascript', 
					 'vbscript', 
					 'expression', 
					 '<applet', '<meta', '<xml', '<blink', '<xlink', '<style', '<script', '<object', '<frame', '<frameset', '<ilayer', '<layer', '<bgsound', '<title', '<base',
					 ...
					 'onfocusout', 'onhelp', 'onkeydown', 'onkeypress', 'onkeyup', 'onlayoutcomplete', 'onload', 'onlosecapture', 'onmousedown', 'onmouseenter', 'onmouseleave', 
					 'onmousemove', 'onmouseout', 'onmouseover', 'onmouseup', 'onmousewheel', 'onmove', 'onmoveend', 'onmovestart', 'onpaste', 'onpropertychange', 'onreadystatechange', 
					 'onreset', 'onresize', 'onresizeend', 'onresizestart', 'onrowenter', 'onrowexit', 'onrowsdelete', 'onrowsinserted', 'onscroll', 'onselect', 'onselectionchange', 
...
$EW_LANGUAGE_FILE[] = array("ar", "", "arabic.xml");
$EW_LANGUAGE_FILE[] = array("en", "", "english.xml");
$EW_LANGUAGE_FILE[] = array("fa", "", "persian.xml");
...
// Security
define("EW_ADMIN_USER_NAME", $ADMIN_USER, TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", $ADMIN_PASS, TRUE); // Administrator password
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,webp,mp3,mp4,doc,xls,pdf,zip,swf,htm,html,shtml,docx,rar,ppt.pptx,txt,exe,jar,sis,sisx,img,cab,psd,tif,vtt", TRUE); // Allowed file extensions
define("EW_IMAGE_ALLOWED_FILE_EXT", "gif,jpg,png,bmp,webp", TRUE); // Allowed file extensions for images
define("EW_DOWNLOAD_ALLOWED_FILE_EXT", "pdf,xls,doc,xlsx,docx", TRUE); // Allowed file extensions for download (non-image)
define("EW_ENCRYPT_FILE_PATH", FALSE, TRUE); // Encrypt file path
define("EW_MAX_FILE_SIZE", 5242880, TRUE); // Max file size
define("EW_MAX_FILE_COUNT", 0, TRUE); // Max file count
define("EW_THUMBNAIL_DEFAULT_WIDTH", 450, TRUE); // Thumbnail default width
define("EW_THUMBNAIL_DEFAULT_HEIGHT", 300, TRUE); // Thumbnail default height
define("EW_THUMBNAIL_DEFAULT_QUALITY", 100, TRUE); // Thumbnail default qualtity (JPEG)
define("EW_ALLIMAGE_MINIMUM_WIDTH", 450, TRUE); // Image minimum width
define("EW_ALLIMAGE_MINIMUM_HEIGHT", 300, TRUE); // Image minimum height
...
define("EW_EXPORT_MASTER_RECORD", FALSE, TRUE); // TRUE to export master record
...
// Use css flip
define("EW_CSS_FLIP", TRUE, TRUE);
$EW_CSS_FLIP = TRUE;
$EW_RTL_LANGUAGES = array("fa", "ar", "he", "ug", "ur");
...
?>
<?php
define("EW_CAPTCHA_FONT", "Roboto_Bold", TRUE);
?>
<?php
