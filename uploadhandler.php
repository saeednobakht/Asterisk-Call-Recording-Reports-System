...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'inline_file_types' => '/\.(gif|jpe?g|png|webp|mp3|mp4)$/i',
    ...
    protected function fix_file_extension($file_path, $name, $size, $type, $error,
		...
		if (strpos($name, '.') === false || preg_match('/[^a-z\d\.]/i', $name) || preg_match('/jpeg/i', $name)) {
            switch ($type) {
                case "image/gif":
                    $name = ew_DefaultFileName().".gif";
                    break;
                case "image/jpeg":
                    $name = ew_DefaultFileName().".jpg";
                    break;
                case "image/png":
                    $name = ew_DefaultFileName().".png";
                    break;
                case "image/bmp":
                    $name = ew_DefaultFileName().".bmp";
                    break;
                case "image/webp":
                    $name = ew_DefaultFileName().".webp";
                    break;
                case "audio/mpeg":
                    $name = ew_DefaultFileName().".mp3";
                    break;
                case "video/mp4":
                    $name = ew_DefaultFileName().".mp4";
                    break;
                case "application/pdf":
                    $name = ew_DefaultFileName().".pdf";
                    break;
                default:
                    $name = ew_DefaultFileName("bin");
            }
        }
