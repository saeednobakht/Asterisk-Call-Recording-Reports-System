...
class cewupload {
	...
	function Page_Main() {
		...
		$EW_IMAGE_MINIMUM_WIDTH  = (@$_POST["minimgwidth"])  ? $_POST["minimgwidth"]  : EW_ALLIMAGE_MINIMUM_WIDTH;
		$EW_IMAGE_MINIMUM_HEIGHT = (@$_POST["minimgheight"]) ? $_POST["minimgheight"] : EW_ALLIMAGE_MINIMUM_HEIGHT;
		...
		$options = array(
			...
			"min_width" => $EW_IMAGE_MINIMUM_WIDTH,
			"min_height" => $EW_IMAGE_MINIMUM_HEIGHT
		);
		$error_messages = array(
			...
			'min_width' => $Language->Phrase("UploadErrMsgMinWidth").': '.$EW_IMAGE_MINIMUM_WIDTH.'px',
			'max_height' => $Language->Phrase("UploadErrMsgMaxHeight"),
			'min_height' => $Language->Phrase("UploadErrMsgMinHeight").': '.$EW_IMAGE_MINIMUM_HEIGHT.'px'
		);
		ob_end_clean();
